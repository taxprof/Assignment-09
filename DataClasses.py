...
class Track:
    ...
    def __init__(self, pos,name,leng):
    #-----Attributes-------#
        self.__position=pos
        self.__title=name
        self.__length=leng
    ...
    @position.setter
    def position(self, value_pos):
        if type(value_pos) == int:
            self.__position=value_pos
        else: 
            raise Exception ('The value for position must be numeric')
    ...
    @title.setter
    def title(self, value_title):
        if type(value_title)==str:
            self.__name=value_title
        else:
    ...
    @length.setter
    def length(self, value_length): 
          if type(value_length)==str:
              self.__length=value_length
          else:
    ...
    def __str__(self):
        return ('{}'.format(str(self.__position) + '\t' + self.__title  + '\t\t' + self.__length))
    
 
    def get_record(self):
        return str(self.__position) + "," + self.__title + ',' + self.__length
