...
# Tessa D, Mar 2022, modified for assignment09
#------------------------------------------#
...
class DataProcessor:
    ...
    def select_cd(table: list, cd_idx: int) -> DC.CD:
        ...
        try:
            ...
            print('Error: The selected CD does not exist') 
    ...
    def add_track(track_info: tuple, cd: DC.CD) -> None:
        ...
        intPosition, strTitle, strLength = track_info
        intPosition = int(intPosition)
        
        try:
            NewTrack = DC.Track(intPosition,strTitle,strLength)
            cd.add_track(NewTrack)
        
        except: 
            print('Error: The track position must be an integer')
